...
export class NuevoViajeComponent {
  ...
  creaViaje() {
    ...
    this.datosVacacionService.creaViaje(
      
      this.formNuevoViaje.value.viaje!,
      this.formNuevoViaje.value.fecha!,
      this.formNuevoViaje.value.imagen!,
      this.formNuevoViaje.value.descripcion!,
      this.formNuevoViaje.value.detalle!);
